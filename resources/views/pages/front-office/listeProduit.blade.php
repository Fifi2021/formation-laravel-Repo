                           ...
                           <thead>
                            ...
                            <tbody>
                                @foreach ($lesproduits as $prod)
                                    <tr>
                                        <td><img src="{{ asset('storage/produits-images/'.$prod->image)}}"width="75%" alt=""></td>
                                        <td>{{$prod->designation}}</td>
                                        <td>{{bf_currency($prod->prix)}} </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                @if(Auth::user()!=null && Auth::user()->isAdmin())
                                                    ...
                                                    <a href="{{route('produit.modifier', $prod->id)}}" class="btn btn-warning mr-2">
